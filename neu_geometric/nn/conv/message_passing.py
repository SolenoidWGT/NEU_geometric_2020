...
class MessagePassing(torch.nn.Module):
    ...
    def __collect__(self, edge_index, size, kwargs):
        ...
        out['index'] = out['edge_index_i']  # 边的终点index
        out['dim_size'] = out['size_i']


        out['x_input'] = kwargs.get("x", inspect.Parameter.empty)
        # out['blocks_node_index'] = None
        # out['block_edge_index'] = None
        # batch_size = kwargs.get("batch_size", inspect.Parameter.empty)
        # if kwargs.get("to_divide", inspect.Parameter.empty):
        #     print("size[0] is :", size[0])
        #     print("batch_size is ", batch_size)
        #     blocks_node_index, block_edge_index = \
        #         divide_blocks(edge_index, p=batch_size, node_num=size[0])
        #     out['blocks_node_index'] = blocks_node_index
        #     out['block_edge_index'] = block_edge_index
