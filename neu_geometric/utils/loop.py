...
def select_self_loops(edge_index):
    row, col = edge_index
    mask = row != col
    # self_loop_mask = row == col
    # self_loop_edge_attr = edge_attr if edge_attr is None else edge_attr[self_loop_mask]
    # self_loop_index = edge_index[:, self_loop_mask]
    _edge_index = edge_index[:, mask]
    return _edge_index
